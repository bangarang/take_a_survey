(function () {
    ...
    render() {
      ...
      if(questions.length || current_question){
        ...
        return (
          <div  className="question_container">
            <div className="options">
              <h1 className="no_more">No More Questions</h1>
              <h3 className="no_more subheader">Come back soon!</h3>
            </div>
          </div>
        )
      }
  ...
  ReactDOM.render( <MainQuestion />, document.getElementById('question'));
})();
